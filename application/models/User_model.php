...
class User_model extends CI_Model {
    ...
    public function add_user($data){
        ...
        if((in_array($data['type'], array(1,2))) && ($data['email'])){
            ...
            $this->email->from("info@countrysidegroup.co.in", "Admin");
            $this->email->to($data['email']);
            $this->email->subject("Welcome to Countryside Group");
            $this->email->message("Welcome to Countryside Group CRM System,<br><br>Your user name is ".$data['emp_code']." And password is ".$data['emp_code']." by using them please login to the tool with the following link: <a href=\"https://crm.countrysidegroup.co.in/\" >https://crm.countrysidegroup.co.in/</a> <br><br>Regards Countryside Group IT team");
            $this->email->send();
        }
    }
    ...
    /*function get_vp_director_admin_emails(){
        ...
        $exceptions = array("info@countrysidegroup.co.in","info@countrysidegroup.co.in");
        $emails = array();
    ...
    function getUsersEmails(){
        ...
        $exceptions = array("info@countrysidegroup.co.in","info@countrysidegroup.co.in", "test@secondsdigital.com");
        $emails = array();
        foreach ($users as $key => $value) {
          if($value->email)
            if(!in_array($value->email,$exceptions))
